...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public void run () {
        String[] text = new String[] { "Taj Hotel", "JW Marriot Hotel", "Madarin Oriental Hotel", "Four Seasons Hotel", "Raddisson Rise Hotel", "Classio Hotel", "The Bay Club Hotel", "Royal Hotel", "River View Hotel"};
        try {
            for (int i=0; i<=9; i++) {
